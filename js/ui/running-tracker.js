...
// La distancia entre dos puntos no es del tracker: la necesita también el
// importador de GPX, que existe precisamente para no depender del tracker.
// Se re-exporta para no romper a quien ya la importaba de aquí.
export { haversine } from './running-helpers.js';
