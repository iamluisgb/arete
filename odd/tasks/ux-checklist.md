...
- [ ] U4: visibility & a11y — sync diagnostic row in backup settings (UX-8), browser GPS
      explanation line (UX-9), non-color HR zone marker (UX-10), sr-only radar table (UX-11).
- [ ] U5: remaining P2 — fs-2xs floor (UX-15), documented decisions for UX-14 (skeletons:
      measure first) and UX-17 (SW notifications: evaluate only).
- [ ] Full suite green.
